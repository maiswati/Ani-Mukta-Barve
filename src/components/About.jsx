    ...
    <div className='container-fluid ' style={{backgroundColor:"#FEFBF8", minHeight: "100vh"}}>
      <div className="row px-4 py-4 mt-5">
        ...
        <div className="col-lg-5 mb-5">
            <img className='img-fluid rounded' src={aboutImage} alt="Mukta Barve theatre performance" loading='lazy' />
        </div>
        <div className="col-lg-7 mt-3 text-center">
            ...
            <img src={sign} alt="Mukta Barve theatre performance" loading='lazy' className='img-fluid mt-5 border border-3 border-dark rounded'/>
        </div>
      </div>
    </div>
  )
