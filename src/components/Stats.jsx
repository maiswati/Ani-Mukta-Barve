    ...
    <div className='container-fluid' style={{backgroundColor:"#FEFBF8", minHeight: "100vh"}}>
          <div className="row m-5">
            ...
            <div className="col-lg-4 text-center">
                <img src={movie} alt="movie" className='img-fluid mb-4' style={{width:"150px"}}/>
                <div>
            ...
            <div className="col-lg-4 text-center">
                <img src={tv} alt="movie" className='img-fluid mb-4' style={{width:"110px"}}/>
                <div>
                    <h1 className='space-mono-bold'>
            ...
            <div className="col-lg-4 text-center">
                <img src={theatre} alt="movie" className='img-fluid mb-4' style={{width:"185px"}}/>
                <div>
                    <h1 className='space-mono-bold'>
